...
Output:
# Földrajzi felfedezések – H5P Build Guide váz v1.0.1

**Kapcsolódó dokumentum:** `dtea-foldrajzi-felfedezesek-master-script-v1.0.1.md`  
...
## 10. Nyitott szakmai döntés

Cabral útjának dátumozása a projektforrásokban nem egységes. A végleges Build Guide nem rögzíthet Timeline-dátumot, amíg a szakmai vezető nem dönt. Addig az oldal 21 elsődleges Timeline-megoldásának tartalék Accordion-változata az egyetlen végrehajtható alternatíva Cabral elemével kapcsolatban.

## 11. v1.0.1 módosítási jegyzet

- A hivatalos skeleton a repository egyetlen példánya.
- A Master Script v1.0.1-re mutató hivatkozás frissült.
...
- Cabral Timeline-dátumozása nyitott szakmai döntésként szerepel.

## 12. Kimenetek a következő sprint végén
