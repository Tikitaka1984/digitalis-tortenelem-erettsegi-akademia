# Földrajzi felfedezések – H5P Build Guide váz v1.0.0

**Kapcsolódó dokumentum:** `dtea-foldrajzi-felfedezesek-master-script-v1.0.0.md`  
...
| 4 | Miért indultak útnak? | okok | Text + Multiple Choice | igen |
| 5 | A hajózás feltételei | eszköz–funkció | Image Hotspots + alternatíva | igen |
| 6 | Portugál kezdeményezés | folyamat | Text + Accordion | igen |
| 7 | Dias útja | tér-idő | Text + Single Choice | igen |
| 8 | Vasco da Gama útja | útvonal | Image Hotspots + Single Choice | igen |
| 9 | Kolumbusz 1492-es útja | fordulópont | Text + Multiple Choice | igen |
| 10 | Tordesillas | térbeli felosztás | Image Hotspots / Course Presentation | igen |
| 11 | Magellán expedíciója | folyamat | Timeline + Single Choice | igen |
| 12 | További utak | rendszerezés | Accordion | igen |
| 13 | Hódítás és gyarmatosítás | ok-okozat | Text + Multiple Choice | igen |
| 14 | Őslakosság és rabszolgaság | következmény | Text + Mark the Words / MC | igen |
| 15 | Kontinensek közötti csere | csoportosítás | Drag and Drop + alternatíva | igen |
| 16 | Az atlanti kereskedelem | gazdasági tér | Text + Single Choice | igen |
| 17 | Árforradalom | oksági lánc | Course Presentation / Accordion | igen |
...
| 20 | Nyugat és Kelet | összehasonlítás | Course Presentation + MC | igen |
...
| 25 | Forráselemzés: Tordesillas | forráskövetkeztetés | Course Presentation / Question Set | igen |
...
## 10. Kimenetek a következő sprint végén
