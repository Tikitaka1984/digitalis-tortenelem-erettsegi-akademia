...
A `H5P.SortParagraphs-0.11` és a standalone player inicializálási sorrendjének ismert eltérését a build SHA-256-tal rögzített, szűken célzott null-őrökkel kezeli. A javítás csak a generált webes artifact könyvtárkódjára vonatkozik; a változatlan forráscsomag továbbra is az integritás alapja.
