...
A történelmi tartalom kizárólag a Source Registerben felsorolt projektforrásokra épül. A forrás-PDF-ek és DOCX-ek nem kerülnek a nyilvános repositoryba. A Master Script saját megfogalmazású tanulói szöveget és forrásleírásokat használ.

## Határon kívül

- a meglévő Athéni demokrácia `.h5p` módosítása;
- működő „Földrajzi felfedezések” H5P build;
- végleges Build Guide;
- új történelmi kép generálása vagy letöltése;
- publikálás vagy automatikus merge.
